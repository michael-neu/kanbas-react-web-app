...
export default function WorkingWithObjects() {
    ...
    return (
        <div id="wd-working-with-objects">
            ...
            <a id="wd-retrieve-assignment-title" className="btn btn-primary me-2" href={`${ASSIGNMENT_API_URL}/completed`}>
                Get Completed
            </a>
            <a id="wd-retrieve-assignment-title" className="btn btn-primary me-2" href={`${ASSIGNMENT_API_URL}/score`}>
                Get Score
            </a>
            <hr />
            ...
            <input className="form-control w-75" id="wd-assignment-title" value={assignment.title} onChange={(event) =>
            ...
            <input id="wd-assignment-checkbox" type="checkbox" onChange={(event) =>
                setAssignment({ ...assignment, completed: Boolean(event.target.value) })} />
            <br />
            <br />
            <hr />
            ...
            <input className="form-control w-75" id="wd-assignment-score" type="number" value={assignment.score} onChange={(event) =>
                setAssignment({ ...assignment, score: Number(event.target.value) })} />
            <hr />
            <h4>
                Get Module
            </h4>
            ...
            <a id="wd-retrieve-module-name" className="btn btn-primary" href={`${MODULE_API_URL}/description`}>
                Get Module Description
            </a>
            <hr />
            ...
            <input className="form-control w-75" id="wd-module-name" value={module.name} onChange={(event) =>
            ...
            <input className="form-control w-75" id="wd-module-description" value={module.description} onChange={(event) =>
