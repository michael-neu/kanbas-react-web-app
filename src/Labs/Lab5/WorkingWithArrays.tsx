...
export default function WorkingWithArrays() {
    ...
    return (
        <div id="wd-working-with-arrays">
            ...
            <input value={todo.id} className="form-control w-25 float-start me-2" onChange={(event) => setTodo({ ...todo, id: event.target.value })} />
            <input value={todo.title} className="form-control w-50 float-start" onChange={(event) => setTodo({ ...todo, title: event.target.value })} />
            <br />
            <br />
            <hr />
            <input value={todo.id} className="form-control w-50" onChange={(e) => setTodo({ ...todo, id: e.target.value })} />
            ...
            <input value={todo.id} className="form-control w-25 float-start me-2" onChange={(event) => setTodo({ ...todo, id: event.target.value })} />
            <input value={todo.description} className="form-control w-25 float-start me-2" onChange={(event) => setTodo({ ...todo, description: event.target.value })} />
            <br />
            <br />
            <hr />
            <h3>
            ...
            <input value={todo.id} className="form-control w-25 float-start me-2" onChange={(event) => setTodo({ ...todo, id: event.target.value })} />
            <input value={Number(todo.completed)} type="checkbox" className="float-start me-2" onChange={(event) => setTodo({ ...todo, completed: Boolean(event.target.value) })} />
            <br />
            <br />
            <hr />
        </div>
